...
if (isset($_POST['amountfield'])&& isset($_POST['cardnumfield'])){
     if((!empty($_POST['amountfield']))&&(!empty($_POST['cardnumfield']))){
       ...
       $result= $transaContr->sendbankcard($transa);
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Send via bank card</h1>
                                    </div>
                                    <form class="user" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                              name="cardnumfield"  aria-describedby="usernameHelp"
