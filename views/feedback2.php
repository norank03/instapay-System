...
if(isset($_POST['update_feedback']))
{
    ...
    $query = "UPDATE feedback SET  status='Read'";
...
if(isset($_POST['save_feedback']))
{
    ...
    $ipa = mysqli_real_escape_string($con, $_POST['ipa']);
    $description = mysqli_real_escape_string($con, $_POST['description']);
    $satus = mysqli_real_escape_string($con, $_POST['lstatus']);


    $query = "INSERT INTO feedback (id,ipa,description,status) VALUES ('$id','$ipa','$description','$status')";
//ha5do men mariam
    $query_run = mysqli_query($con, $query);
    if($query_run)
    {
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="font-weight:bold"class="h3 mb-2 text-gray-800">Feedbacks Table</h1>
                                        ...
                                        foreach($query_run as $feedback)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="feedback2.php" method="POST" class="d-inline">
                                                        <button type="submit" name="update_feedback" value="<?=$feedback['id'];?>"  style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  padding: 5px;
  text-align: center;
  ...
  font-size: 16px;
  margin: 4px 2px;
  cursor: pointer;background-colopr:#47d147"class="btn btn-danger btn-sm">Check</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
